...
namespace Sungero.Projects.Server
{
  public partial class ModuleInitializer
  {
    ...
    {
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.FirstInitializing, Constants.Module.Init.Projects.Name, Version.Parse(Constants.Module.Init.Projects.FirstInitVersion));
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.Initializing49, Constants.Module.Init.Projects.Name, Version.Parse(Constants.Module.Init.Projects.Version49));
    }
    ...
    public static void CreateDocumentTypes()
    {
      ...
      Docflow.PublicInitializationFunctions.Module.CreateDocumentType(Sungero.Projects.Resources.ProjectTypeName,
                                                                      ProjectDocument.ClassTypeGuid,
