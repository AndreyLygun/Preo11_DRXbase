...
namespace Sungero.Company.Client
{
  ...
  {
    public virtual void OpenPersonalSettings(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      Sungero.Docflow.PublicFunctions.Module.ShowCurrentPersonalSettings();
    }

    public virtual bool CanOpenPersonalSettings(Sungero.Domain.Client.CanExecuteActionArgs e)
    {
      return Equals(_obj, Company.Employees.Current);
    }
