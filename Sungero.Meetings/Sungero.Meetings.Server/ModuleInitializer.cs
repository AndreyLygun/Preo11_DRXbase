...
namespace Sungero.Meetings.Server
{
  public partial class ModuleInitializer
  {
    ...
    {
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.FirstInitializing, Constants.Module.Init.Meetings.Name, Version.Parse(Constants.Module.Init.Meetings.FirstInitVersion));
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.Initializing49, Constants.Module.Init.Meetings.Name, Version.Parse(Constants.Module.Init.Meetings.Version49));
    }
    ...
    public static void CreateRoles()
    {
      ...
      var meetingResponsibleRole = Docflow.PublicInitializationFunctions.Module.CreateRole(Resources.NameMeetingResponsibleRole,
                                                                                           Resources.DescriptionMeetingResponsibleRole,
                                                                                           Constants.Module.MeetingResponsibleRole);
      Docflow.PublicInitializationFunctions.Module.CreateRole(Resources.NameUsersWithAccessToMeetingRole,
                                                              Resources.DescriptionUsersWithAccessToMeetingRole,
                                                              Constants.Module.UsersWithAccessToMeetingRole,
                                                              new List<IRecipient> { meetingResponsibleRole });
    }
    ...
    public static void GrantRightOnFolders(IRole role)
    {
      ...
      try
      {
        ...
        Sungero.Meetings.SpecialFolders.Minutes.AccessRights.Grant(role, DefaultAccessRightsTypes.Read);
        MeetingsUI.SpecialFolders.Minutes.AccessRights.Save();
        Sungero.Meetings.SpecialFolders.Minutes.AccessRights.Save();
      }
      finally
      {
