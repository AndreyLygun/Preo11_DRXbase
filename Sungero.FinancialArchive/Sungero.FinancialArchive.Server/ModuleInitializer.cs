...
namespace Sungero.FinancialArchive.Server
{
  public partial class ModuleInitializer
  {
    ...
    {
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.FirstInitializing, Constants.Module.Init.FinancialArchive.Name, Version.Parse(Constants.Module.Init.FinancialArchive.FirstInitVersion));
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.Initializing49, Constants.Module.Init.FinancialArchive.Name, Version.Parse(Constants.Module.Init.FinancialArchive.Version49));
    }
    ...
    public static void CreateRoles()
    {
      ...
      var financialArchiveResponsibleRole = Docflow.PublicInitializationFunctions.Module.CreateRole(Resources.RoleNameFinancialArchiveResponsible,
                                                                                                    Resources.DescriptionFinancialArchiveResponsible,
                                                                                                    Constants.Module.FinancialArchiveResponsibleRole);
      
      Docflow.PublicInitializationFunctions.Module.CreateRole(Resources.RoleNameUsersWithAccessToFinancialArchive,
                                                              Resources.DescriptionUsersWithAccessToFinancialArchiveRole,
                                                              Constants.Module.UsersWithAccessToFinancialArchiveRole,
                                                              new List<IRecipient> { financialArchiveResponsibleRole });
    }
    ...
    public static void GrantRightOnFolders(IRole role)
    {
      ...
      try
      {
        ...
        FinancialArchive.SpecialFolders.FinContractList.AccessRights.Grant(role, DefaultAccessRightsTypes.Read);
        FinancialArchiveUI.SpecialFolders.FinContractList.AccessRights.Save();
        FinancialArchive.SpecialFolders.FinContractList.AccessRights.Save();
        ...
        FinancialArchive.SpecialFolders.DocumentsWithoutScan.AccessRights.Grant(role, DefaultAccessRightsTypes.Read);
        FinancialArchiveUI.SpecialFolders.DocumentsWithoutScan.AccessRights.Save();
        FinancialArchive.SpecialFolders.DocumentsWithoutScan.AccessRights.Save();
        ...
        FinancialArchive.SpecialFolders.SignAwaitedDocuments.AccessRights.Grant(role, DefaultAccessRightsTypes.Read);
        FinancialArchiveUI.SpecialFolders.SignAwaitedDocuments.AccessRights.Save();
        FinancialArchive.SpecialFolders.SignAwaitedDocuments.AccessRights.Save();
      }
      finally
      {
        Docflow.PublicFunctions.Module.RestoreLicense(licenses);
    ...
    public static void CreateDocumentKinds()
    {
      ...
      Docflow.PublicInitializationFunctions.Module.CreateDocumentKind(Resources.WaybillDocumentKindName,
                                                                      ...
                                                                      new[] { Waybills.Info.Actions.SendForFreeApproval, Waybills.Info.Actions.SendForDocumentFlow },
