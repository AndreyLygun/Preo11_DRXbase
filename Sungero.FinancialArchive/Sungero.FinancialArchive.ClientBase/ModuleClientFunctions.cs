...
namespace Sungero.FinancialArchive.Client
{
  public class ModuleFunctions
  {
    ...
    /// </summary>
    [Public, LocalizeFunction("ImportAndShowDocumentFromFileDialogFunctionName", "ImportAndShowDocumentFromFileDialogFunctionDescription")]
    public virtual void ImportAndShowDocumentFromFileDialog()
    {
      ...
      {
        Dialogs.NotifyMessage(Sungero.FinancialArchiveUI.Resources.NoImportDocumentLicense);
        return;
      }
