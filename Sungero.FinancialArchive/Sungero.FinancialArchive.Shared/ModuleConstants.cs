...
namespace Sungero.FinancialArchive.Constants
{
  ...
  {
    // GUID роли "Ответственные за финансовый архив".
    [Sungero.Core.Public]
    public static readonly Guid FinancialArchiveResponsibleRole = Guid.Parse("A35F4302-848F-4022-84DD-4AA2978ECF9A");
    
    // GUID роли "Пользователи с доступом к финансовому архиву".
    [Sungero.Core.Public]
    public static readonly Guid UsersWithAccessToFinancialArchiveRole = Guid.Parse("FF14062C-DA57-4D9C-A82D-3EDEE9DBE840");
    ...
    {
      public static class FinancialArchive
      {
        /// <summary>
        /// Название параметра для хранения проинициализированной версии кода модуля.
        /// </summary>
        public const string Name = "InitFinancialArchiveUpdate";
