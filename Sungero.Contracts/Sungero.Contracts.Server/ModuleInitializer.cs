...
namespace Sungero.Contracts.Server
{
  public partial class ModuleInitializer
  {
    ...
    {
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.FirstInitializing, Constants.Module.Init.Contracts.Name, Version.Parse(Constants.Module.Init.Contracts.FirstInitVersion));
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.Initializing49, Constants.Module.Init.Contracts.Name, Version.Parse(Constants.Module.Init.Contracts.Version49));
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.Initializing411, Constants.Module.Init.Contracts.Name, Version.Parse(Constants.Module.Init.Contracts.Version411));
    }
    ...
    public static void GrantRightOnFolders(IRole allUsers)
    {
      ...
      try
      {
        ...
        Sungero.Contracts.SpecialFolders.ContractsList.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);
        Sungero.Contracts.SpecialFolders.ExpiringSoonContracts.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);
        Sungero.Contracts.SpecialFolders.ContractsAtContractors.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);
        Sungero.Contracts.SpecialFolders.IssuanceJournal.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);
        Sungero.Contracts.SpecialFolders.ContractsHistory.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);
        ...
        Sungero.Contracts.SpecialFolders.ContractsList.AccessRights.Save();
        Sungero.Contracts.SpecialFolders.ExpiringSoonContracts.AccessRights.Save();
        Sungero.Contracts.SpecialFolders.ContractsAtContractors.AccessRights.Save();
        Sungero.Contracts.SpecialFolders.IssuanceJournal.AccessRights.Save();
        Sungero.Contracts.SpecialFolders.ContractsHistory.AccessRights.Save();
    ...
    public static void CreateRoles()
    {
      ...
      var contractsResponsibleRole = Docflow.PublicInitializationFunctions.Module.CreateRole(Docflow.Resources.RoleNameContractsResponsible,
                                                                                             Resources.DescriptionResponsibleForContractsRole,
                                                                                             Docflow.Constants.Module.RoleGuid.ContractsResponsible);
      Docflow.PublicInitializationFunctions.Module.CreateRole(Docflow.Resources.RoleNameRegistrationContracts,
                                                              Resources.DescriptionContractsRegistrarRole,
                                                              Docflow.Constants.Module.RoleGuid.RegistrationContractualDocument);
      Docflow.PublicInitializationFunctions.Module.CreateRole(Resources.RoleNameUsersWithAccessToContracts,
                                                              Resources.DescriptionUsersWithAccessToContractsRole,
                                                              Constants.Module.UsersWithAccessToContractsRole,
                                                              new List<IRecipient> { contractsResponsibleRole });
    }
    ...
    public static void CreateDocumentKinds()
    {
      ...
      Docflow.PublicInitializationFunctions.Module.CreateDocumentKind(Sungero.Contracts.Resources.IncomingInvoiceKindName,
                                                                      ...
                                                                      IncomingInvoice.ClassTypeGuid, new Domain.Shared.IActionInfo[] { OfficialDocuments.Info.Actions.SendForFreeApproval, OfficialDocuments.Info.Actions.SendForDocumentFlow },
    ...
    public static void CreateDefaultRelationTypes()
    {
      ...
      supAgreementRow.Source = Sungero.Contracts.ContractualDocuments.Info;
