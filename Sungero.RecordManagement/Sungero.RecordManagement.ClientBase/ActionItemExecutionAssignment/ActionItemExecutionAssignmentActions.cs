...
namespace Sungero.RecordManagement.Client
{
  partial class ActionItemExecutionAssignmentActions
  {
    ...
    public virtual void CreateReplyLetter(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      ...
      if (document != null)
      {
        var outgoingLetter = Docflow.PublicFunctions.OfficialDocument.Remote.CreateReplyDocument(document);
    ...
    public virtual void Done(Sungero.Workflow.Client.ExecuteResultActionArgs e)
    {
      ...
      if (!Equals(actionItemTask.Assignee, _obj.Performer) && _obj.ForwardedTo.Any())
      {
      ...
      var giveRights = Docflow.PublicFunctions.Module.ShowDialogGrantAccessRights(_obj, _obj.OtherGroup.All.ToList());
      if (giveRights == false)
        e.Cancel();
    ...
    {
      return _obj.AccessRights.CanUpdate() && Docflow.PublicFunctions.Module.IsWorkStarted(_obj);
    }
