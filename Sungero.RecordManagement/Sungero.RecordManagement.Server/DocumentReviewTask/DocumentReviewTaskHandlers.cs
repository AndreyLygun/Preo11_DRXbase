...
namespace Sungero.RecordManagement
{
  ...
  partial class DocumentReviewTaskServerHandlers
  {
    ...
    public override void BeforeSave(Sungero.Domain.BeforeSaveEventArgs e)
    {
      ...
      // Права на проекты резолюций не выдаются, чтобы инициатор не получал права на созданный виртуальным ассистентом проект резолюции,
      // если выдать права - инициатор не сможет рестартовать задачу с таким проектом. Bug 328465.
