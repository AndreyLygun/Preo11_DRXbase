...
namespace Sungero.RecordManagement
{
  partial class ActionItemsExecutionReportServerHandlers
  {
    ...
    public override void BeforeExecute(Sungero.Reporting.Server.BeforeExecuteEventArgs e)
    {
      ...
      actionItems = RecordManagement.Functions.Module.FillLightActionItemListAuthors(actionItems);
      actionItems = RecordManagement.Functions.Module.FillLightActionItemListAssignees(actionItems);
      actionItems = RecordManagement.Functions.Module.FillLightActionItemListCoAssigneeShortNames(actionItems);
      ...
      foreach (var actionItem in actionItems.OrderBy(a => a.Deadline))
      {
        ...
        tableLine.CoAssignees = actionItem.CoAssigneeShortNames;
