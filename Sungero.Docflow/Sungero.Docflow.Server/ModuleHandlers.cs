...
namespace Sungero.Docflow.Server
{
  partial class PowerOfAttorneyListFolderHandlers
  {
    ...
    public virtual IQueryable<Sungero.Docflow.IPowerOfAttorneyBase> PowerOfAttorneyListPreFiltering(IQueryable<Sungero.Docflow.IPowerOfAttorneyBase> query)
    {
      if (_filter == null)
        return query;
      
      if (Functions.Module.UsePrefilterPowerOfAttorneyList(_filter))
      {
        query = Functions.Module.PowerOfAttorneyListApplyStrongFilter(query, _filter);
        query = Functions.Module.PowerOfAttorneyListApplyOrdinaryFilter(query, _filter);
      }
    ...
    public virtual IQueryable<Sungero.Docflow.IPowerOfAttorneyBase> PowerOfAttorneyListDataQuery(IQueryable<Sungero.Docflow.IPowerOfAttorneyBase> query)
    {
      ...
      query = Functions.Module.PowerOfAttorneyListApplyWeakFilter(query, _filter);
