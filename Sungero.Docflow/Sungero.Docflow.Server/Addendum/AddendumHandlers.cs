  ...
  partial class AddendumServerHandlers
  {
    ...
    public override void BeforeSave(Sungero.Domain.BeforeSaveEventArgs e)
    {
      ...
      if (leadingDocumentChanged)
      {
        ...
        if (Functions.OfficialDocument.IsProjectDocument(_obj.LeadingDocument, new List<long>()))
      ...
      if (_obj.LeadingDocument != null && _obj.LeadingDocument.AccessRights.CanRead() &&
          !_obj.Relations.GetRelatedFromDocuments(Constants.Module.AddendumRelationName).Any(x => x.Id == _obj.LeadingDocument.Id))
