...
namespace Sungero.Docflow.Server
{
  partial class CheckReturnTaskFunctions
  {
    ...
    [Public, Obsolete("Метод не используется с 17.04.2024 и версии 4.10, так как больше не актуален.")]
    ...
    public static void SetReturnResult(Sungero.Docflow.ICheckReturnTask returnControl, IUser performer, bool documentIsReturned)
    {
      ...
      if (!Docflow.Functions.Module.IsTaskUsingOldScheme(returnControl))
        ((Domain.Shared.IExtendedEntity)document).Params[Docflow.Constants.Module.CheckReturnTaskCallContext] = true;
      ...
      Functions.OfficialDocument.WriteTrackingLog("CheckReturnTask. Set return Result.", tracking);
    }
