  ...
  partial class CheckReturnTaskRouteHandlers
  {
    ...
    public virtual bool Monitoring2Result()
    {
      ...
      Logger.WithLogger(Constants.Module.TrackingLoggerPostfix)
        .Debug(string.Format("CheckReturnTask. Monitoring. Task: {0}, AssignmentStartDate: {1}, " +
                             "Tracking is not null: {2}, Row date: {3}",
                             _obj.Id, _obj.AssignmentStartDate, tracking != null,
