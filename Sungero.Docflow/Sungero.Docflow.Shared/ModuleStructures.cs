...
namespace Sungero.Docflow.Structures.Module
{
  ...
  /// <summary>
  /// Модель документа с метаданными отметок.
  /// </summary>
  [Public(Isolated = true)]
  partial class DocumentMarksDto
  {
    /// <summary>
    /// ИД документа.
    /// </summary>
    ...
    /// <summary>
    /// Расширение оригинала документа.
    /// </summary>
    public string BodyExtension { get; set; }
    
    /// <summary>
    /// Лимит страниц для поиска якоря.
    /// </summary>
    public int? MaxAnchorSearchPageCount { get; set; }
    
    /// <summary>
    /// Признак успешного преобразования в PDF.
    /// </summary>
    ...
    /// Отметки.
    /// </summary>
    public List<Sungero.Docflow.Structures.Module.IMarkDto> Marks { get; set; }
  }
  ...
  partial class MarkDto
  {
    ...
    /// <summary>
    /// Теги для вставки в оригинальный документ.
    /// </summary>
    ...
    /// <summary>
    /// Горизонтальная координата для вставки отметки.
    /// </summary>
    public double X { get; set; }
    
    /// <summary>
    /// Вертикальная координата для вставки отметки.
    /// </summary>
    ...
    /// <summary>
    /// Номер страницы для вставки отметки.
    /// </summary>
    ...
    /// <summary>
    /// ИД предыдущей отметки, от которой отсчитывать координаты для вставки.
    /// </summary>
    public long? ParentMarkId { get; set; }
    
    /// <summary>
    /// Отметка  проставлена успешно. True - успех, False - ошибка.
    /// </summary>
    public bool IsSuccessful { get; set; }
    
    /// <summary>
    /// Проставить отметку на последней, дополнительной странице.
    /// </summary>
    public bool? OnBlankPage { get; set; }
    ...
    /// <summary>
    /// Дополнительные параметры отметки.
    /// </summary>
  ...
  /// <summary>
  /// Список свойств поручения в протоколе.
  /// </summary>
  [Public(Isolated = true)]
  partial class MinutesActionItem
  {
  ...
  partial class EmployeeSubstitutions
  {
    ...
    /// Замещаемый.
    /// </summary>
    public long SubstitutedId { get; set; }
    
    /// <summary>
    /// Замещаемый должен получать сводку по заданиям и задачам.
    /// </summary>
    public bool? SubstitutedNeedNotifyAssignmentsSummary { get; set; }
  ...
  partial class DatabooksWithNullCode
  {
    ...
    public bool HasContractCategoriesWithNullCode { get; set; }
  }
  ...
  /// </summary>
  [Public]
  partial class PdfConversionResult
  {
    /// <summary>
    /// Признак конвертации с использованием Ario.
    /// </summary>
    public bool IsArioConversion { get; set; }

    /// <summary>
    /// Признак завершения конвертации.
    /// </summary>
    ...
    /// ИД задачи Ario.
    /// </summary>
    public int ArioTaskId { get; set; }

    /// <summary>
    /// Гуид документа.
    /// </summary>
    public string ArioGuid { get; set; }

    /// <summary>
    /// Конвертированное тело документа.
    /// </summary>
    public byte[] Body { get; set; }
  ...
  /// </summary>
  [Public(Isolated = true)]
  partial class DocumentComparisonResult
  {
    /// <summary>
    /// Число различий документов.
    /// </summary>
    public int DifferencesCount { get; set; }
    
    /// <summary>
    /// Признак того, что тела документов слишком разные.
    /// </summary>
    public bool DocumentsAreDifferent { get; set; }
    
    /// <summary>
    /// Результат сравнения в формате PDF.
    /// </summary>
    public byte[] ResultPdf { get; set; }
  }
  
  /// <summary>
  /// Результат показа диалога переадресации.
  /// </summary>
  [Public]
  partial class ForwardingDialogResult
  {
    /// <summary>
    /// В диалоге была нажата кнопка "Переадресовать".
    /// </summary>
    public bool ForwardButtonIsPressed { get; set; }
    
    /// <summary>
    /// Кому переадресовали.
    /// </summary>
    public Company.IEmployee ForwardTo { get; set; }
