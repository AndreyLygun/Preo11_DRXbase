...
namespace Sungero.Docflow
{
  ...
  partial class OfficialDocumentClientHandlers
  {
    ...
    public virtual void StoredInValueInput(Sungero.Presentation.StringValueInputEventArgs e)
    {
      if (!string.IsNullOrEmpty(e.NewValue))
        e.NewValue = e.NewValue.Trim();
    }

    public virtual void AddendaPaperCountValueInput(Sungero.Presentation.IntegerValueInputEventArgs e)
    {
      if (e.NewValue != null && e.NewValue < 0)
        e.AddError(Sungero.Docflow.OfficialDocuments.Resources.AddendaPaperCountMustBePositive);
    }

    public virtual void TopicValueInput(Sungero.Docflow.Client.OfficialDocumentTopicValueInputEventArgs e)
    {
      if (e.NewValue != e.OldValue)
        _obj.Subtopic = null;
      _obj.State.Properties.Subtopic.IsEnabled = e.NewValue != null;
    }

    public virtual void PaperCountValueInput(Sungero.Presentation.IntegerValueInputEventArgs e)
    {
      if (e.NewValue != null && e.NewValue < 0)
        e.AddError(Sungero.Docflow.OfficialDocuments.Resources.PaperCountMustBePositive);
    }
    ...
    public override void Closing(Sungero.Presentation.FormClosingEventArgs e)
    {
      ...
      ((Domain.Shared.IExtendedEntity)_obj).Params.Remove(Sungero.Docflow.Constants.OfficialDocument.DeletedMarkIdsParamName);
    }
    ...
    public virtual void ProjectValueInput(Sungero.Docflow.Client.OfficialDocumentProjectValueInputEventArgs e)
    {
      ...
      if (e.NewValue != null && !Equals(e.NewValue, e.OldValue) && Projects.ProjectCores.Is(e.NewValue))
    ...
    public override void Refresh(Sungero.Presentation.FormRefreshEventArgs e)
    {
      ...
      // Отобразить однократно нотифайку о выдаче прав на проектные документы.
      if (_obj.State.IsInserted && _obj.Project != null && Projects.ProjectCores.Is(_obj.Project))
        Projects.PublicFunctions.Module.ShowProjectRightsNotifyOnce(e, Projects.ProjectCores.Resources.ProjectDocumentRightsNotifyMessage);
