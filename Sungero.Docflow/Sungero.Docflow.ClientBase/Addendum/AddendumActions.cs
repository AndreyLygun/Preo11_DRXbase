  ...
  partial class AddendumActions
  {
    public virtual void UnbindAddendum(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      ...
      try
      {
        ...
        // Сохраняем ИД ведущего документа, чтобы удалить связь на сохранении. BUG200516.
        ((Sungero.Domain.Shared.IExtendedEntity)convertedDocument).Params.Add(Constants.Module.LeadingDocumentIdParamName, _obj.LeadingDocument.Id);
