...
namespace Sungero.Docflow.Client
{
  ...
  {
    public virtual void ShowContractCategoriesWithNullCode(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      var categories = Contracts.PublicFunctions.ContractCategory.Remote.GetContractCategoriesWithNullCode();
      categories.Show();
    }

    public virtual bool CanShowContractCategoriesWithNullCode(Sungero.Domain.Client.CanExecuteActionArgs e)
    {
      return true;
    }
    ...
    {
      var documentKinds = Functions.DocumentKind.Remote.GetDocumentKindsWithNullCode();
      documentKinds.Show();
    }
    ...
    {
      var businessUnits = Company.PublicFunctions.BusinessUnit.Remote.GetBusinessUnitsWithNullCode();
      businessUnits.Show();
    }
    ...
    {
      var departments = Company.PublicFunctions.Department.Remote.GetDepartmentsWithNullCode();
      departments.Show();
    }
