...
namespace Sungero.Docflow.Client
{
  ...
  {
    public override void SendForDocumentFlow(Sungero.Domain.Client.ExecuteActionArgs e)
    {
      base.SendForDocumentFlow(e);
    }

    public override bool CanSendForDocumentFlow(Sungero.Domain.Client.CanExecuteActionArgs e)
    {
      return false;
    }
