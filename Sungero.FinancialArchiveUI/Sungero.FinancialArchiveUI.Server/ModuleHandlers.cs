...
namespace Sungero.FinancialArchiveUI.Server
{
  ...
  {
    [Obsolete("Метод не используется с 11.01.2024 и версии 4.9. Используйте вычисляемую папку SignAwaitedDocuments модуля FinancialArchive.")]
  ...
  {
    [Obsolete("Метод не используется с 11.01.2024 и версии 4.9. Используйте вычисляемую папку DocumentsWithoutScan модуля FinancialArchive.")]
  ...
  {
    [Obsolete("Метод не используется с 11.01.2024 и версии 4.9. Используйте вычисляемую папку FinContractList модуля FinancialArchive.")]
