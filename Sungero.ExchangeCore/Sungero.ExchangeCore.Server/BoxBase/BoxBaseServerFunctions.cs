...
namespace Sungero.ExchangeCore.Server
{
  partial class BoxBaseFunctions
  {
    ...
    /// <summary>
    /// Получить ответственного за документ (ответственный за контрагента или за абонентский ящик).
    /// </summary>
    /// <param name="counterparty">Контрагент.</param>
    /// <param name="infos">Список информаций о документе.</param>
    /// <returns>Ответственный.</returns>
    [Public, Remote]
    public virtual Sungero.Company.IEmployee GetExchangeDocumentResponsible(Sungero.Parties.ICounterparty counterparty,
