...
namespace Sungero.ExchangeCore.Server
{
  public partial class ModuleInitializer
  {
    ...
    {
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.FirstInitializing, Constants.Module.Init.ExchangeCore.Name, Version.Parse(Constants.Module.Init.ExchangeCore.FirstInitVersion));
      
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.Initializing49, Constants.Module.Init.ExchangeCore.Name, Version.Parse(Constants.Module.Init.ExchangeCore.Version49));
    }
    ...
    public static void GrantRightsOnDatabooks()
    {
      ...
      CounterpartyDepartmentBoxes.AccessRights.Grant(allUsers, DefaultAccessRightsTypes.Read);

      BoxBases.AccessRights.Save();
      ExchangeServices.AccessRights.Save();
      CounterpartyDepartmentBoxes.AccessRights.Save();
    }
