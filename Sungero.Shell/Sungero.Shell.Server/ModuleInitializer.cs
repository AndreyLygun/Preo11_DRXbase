...
namespace Sungero.Shell.Server
{
  public partial class ModuleInitializer
  {
    ...
    {
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.FirstInitializing, Constants.Module.Init.Shell.Name, Version.Parse(Constants.Module.Init.Shell.FirstInitVersion));
      
      Sungero.Commons.PublicInitializationFunctions.Module.ModuleVersionInit(this.Initializing49, Constants.Module.Init.Shell.Name, Version.Parse(Constants.Module.Init.Shell.Version49));
    }
